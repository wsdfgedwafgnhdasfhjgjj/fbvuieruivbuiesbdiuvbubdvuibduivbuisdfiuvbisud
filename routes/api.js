    ...
    try {
      ...
      var result = today;
          res.json({
            ...
            code: 200,
            creator: `${creator}`,
            img: 'https://i.pinimg.com/736x/9f/47/76/9f4776fa096a161be1b6b11bf545506f.jpg',
            result
          })
        } catch (e) {loghandler.error}
} else {
res.json(loghandler.invalidKey)
}
})
...
router.get('/fun/simisimi-en', async (req, res, next) => {
        var Apikey = req.query.apikey
            text = req.query.text
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.simsimi.net/v2/?text=${text}&lc=eng`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
router.get('/fun/simisimi-jp', async (req, res, next) => {
        var Apikey = req.query.apikey
            text = req.query.text
	...
	if(listkey.includes(Apikey)){
       ...
       fetch(encodeURI(`https://api.simsimi.net/v2/?text=${text}&lc=ja`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
